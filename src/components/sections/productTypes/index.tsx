...
const ProductCard: React.FC<ProductCardProps> = ({title, description}) => {
    return (
        <div className="flex flex-col justify-end w-60 h-40 border-1 hover:border-c-primary px-4 pb-3 rounded-md">
            <h6>{title}</h6>
